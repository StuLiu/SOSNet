...
__all__ = ['polylr', 'warmuppolylr', 'warmupcosinelr', 'warmupsteplr', 'get_scheduler']
...
if __name__ == '__main__':
    ...
    # sched = WarmupExpLR(optim, gamma=0.9999, warmup_iter=450, warmup_ratio=0.1, warmup='exp', last_epoch=-1)
