...
class ResNetD(nn.Module):
    def __init__(self, model_name: str = '50') -> None:
        ...
        self.block, self.depths, self.channels = resnetd_settings[model_name]
        ...
        self.layer3 = self._make_layer(self.block, 256, self.depths[2], s=2, d=2)
        self.layer4 = self._make_layer(self.block, 512, self.depths[3], s=2, d=4)
