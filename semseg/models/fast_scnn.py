...
class FastSCNN(BaseModel):
    def __init__(self, backbone: str = None, num_classes: int = 19):
        super(FastSCNN, self).__init__(backbone, num_classes)
...
if __name__ == '__main__':
    _img = torch.randn(32, 3, 512, 1024).cuda()
    _model = FastSCNN(num_classes=6).cuda()
    _outputs = _model(_img)
    pass
